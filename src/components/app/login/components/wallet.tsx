...
const Wallet = function ({ name, image, onConnectWallet }: Props) {
    return (
        <Button
            ...
            className={cn(
                'relative box-border flex h-[50px] w-[332px] cursor-pointer select-none items-center justify-between rounded-xl border-[1px] border-solid border-gray-700 bg-transparent px-[22px] py-[5px] text-[16px] text-white hover:bg-slate-700',
            )}
        >
