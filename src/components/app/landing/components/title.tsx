    ...
    return (
        <section className="relative mx-auto mb-[30px] flex flex-col items-center justify-center">
            <div className="relative mt-[15px] text-[42px] leading-[50px] text-[#fff]">
                <h3 className="mb-3 font-bold text-white">Features</h3>
                <svg
            ...
            <p className="max-w-[600px] text-center font-normal">
                Empowering Blockchain Innovation with Dynamic Metadata Upgrades and Seamless Asset
                Management
            </p>
        </section>
    );
