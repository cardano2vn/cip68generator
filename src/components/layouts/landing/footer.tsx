        ...
        <div>
            ...
            <section className={cn('mt-[100px] flex justify-between max-sm:flex-col')}>
                ...
                <div className={cn('flex gap-[45px] leading-[20px]')}>
                    <ul>
                        <h2 className={cn('mb-9 text-[19px] font-bold text-white')}>Products</h2>
                    ...
                    <ul>
                        <h2 className={cn('mb-9 text-[19px] font-bold text-white')}>Resources</h2>
                        <li className={cn('mt-[25px]')}>
                            <Link
                                className={cn(
                                    'cursor-pointer text-[15px] leading-[20px] text-gray-400',
                    ...
                    <ul>
                        <h2 className={cn('mb-9 text-[19px] font-bold text-white')}>Developers</h2>
                        <li className={cn('mt-[25px]')}>
                            <Link
                                className={cn(
                                    'cursor-pointer text-[15px] leading-[20px] text-gray-400',
                    ...
                    <ul>
                        <h2 className={cn('mb-9 text-[19px] font-bold text-white')}>Learn More</h2>
                        <li className={cn('mt-[25px]')}>
                            <Link
                                className={cn(
                                    'cursor-pointer text-[15px] leading-[20px] text-gray-400',
